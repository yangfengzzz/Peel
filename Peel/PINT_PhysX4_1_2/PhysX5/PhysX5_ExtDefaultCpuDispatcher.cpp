...
physx5::PxDefaultCpuDispatcher* physx5::PxDefaultCpuDispatcherCreate(PxU32 numThreads,
                                                                     PxU32* affinityMasks,
...
physx5::Ext::DefaultCpuDispatcher::DefaultCpuDispatcher(PxU32 numThreads,
                                                        PxU32* affinityMasks,
                                                        PxDefaultCpuDispatcherWaitForWorkMode::Enum mode,
                                                        PxU32 yieldProcessorCount)
...
void physx5::Ext::DefaultCpuDispatcher::release() { PX_DELETE(this); }
