...
public:
    ...
    inline_ const ActorData* GetStaticActors() const {
        return reinterpret_cast<const ActorData*>(mStaticActors.GetEntries());
    }
    inline_ const ActorData* GetDynamicActors() const {
        return reinterpret_cast<const ActorData*>(mDynamicActors.GetEntries());
    }
