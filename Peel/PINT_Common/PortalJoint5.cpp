...
static PxConstraintShaderTable gPortalJointShaders = {PortalJointSolverPrep, PortalJointProject, PortalJointVisualize,
...
PxPortalJoint* physx::PxPortalJointCreate(PxPhysics& physics,
    ...
    return createJointT<PortalJoint, PortalJointData>(physics, actor0, localFrame0, actor1, localFrame1,
                                                      gPortalJointShaders);
}
