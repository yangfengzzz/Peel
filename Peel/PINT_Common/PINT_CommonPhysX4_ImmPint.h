...
public:
    ...
    //		virtual	bool			AddRCArticulationToAggregate(PintArticHandle articulation, PintObjectHandle aggregate)
    //{ NotImplemented("AddRCArticulationToAggregate");	return false;	} 		virtual	bool
    //SetRCADriveEnabled(PintObjectHandle handle, bool flag)																	{
    //NotImplemented("SetRCADriveEnabled");				return false;	} 		virtual	bool
    //SetRCADriveVelocity(PintObjectHandle handle, float velocity)															{
    //NotImplemented("SetRCADriveVelocity");			return false;	} ~Pint
