...
HPoint GetSunColorAndIntensity() { return gSun.GetColorAndIntensity(); }
...
void SetupAtmosphereShaderParams(GLuint shader_program) {
    ...
    // printf("vSunColorIntensity: %f %f %f %f\n", vSunColorIntensity.x, vSunColorIntensity.y, vSunColorIntensity.z,
    // vSunColorIntensity.w);
    GLShader::SetUniform3f(shader_program, "CV_SUN_COLOR", vSunColorIntensity.x, vSunColorIntensity.y,
                           vSunColorIntensity.z);
    ...
    GLShader::SetUniform3f(shader_program, "CV_ONE_OVER_BETA_1_PLUS_2", vOneOverBetaRM.x, vOneOverBetaRM.y,
                           vOneOverBetaRM.z);
