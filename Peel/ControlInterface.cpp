...
void SetControlInterface(PEEL::ControlInterface* ci) { gControlInterface = ci; }

PEEL::ControlInterface* GetControlInterface() { return gControlInterface; }

static MouseInfo gMouseInfo;

const MouseInfo& GetMouseInfo() { return gMouseInfo; }
