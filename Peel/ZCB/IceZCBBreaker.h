...
public:
    ...
    float mNearClip;      //!< Near/hither clip
                          //!< [Animatable]
    float mFarClip;       //!< Far/yon clip
                          //!< [Animatable]
    float mTDist;         //!< Distance to target
                          //!< [Animatable]
    long mHLineDisplay;   //!< Horizon Line Display
    float mEnvNearRange;  //!< Environment near range
                          //!< [Animatable]
    float mEnvFarRange;   //!< Environment far range
                          //!< [Animatable]
...
public:
    ...
    Point mColor;              //!< Light's color
                               //!< [Animatable]
    float mIntensity;          //!< Light's intensity
                               //!< [Animatable]
    float mContrast;           //!< Light's contrast
                               //!< [Animatable]
    float mDiffuseSoft;        //!< Light's diffuse soft
                               //!< [Animatable]
    ...
    bool mShowAtten;           //
    float mNearAttenStart;     //!< Near atten start
                               //!< [Animatable]
    float mNearAttenEnd;       //!< Near atten end
                               //!< [Animatable]
    float mAttenStart;         //!< Atten start
                               //!< [Animatable]
    float mAttenEnd;           //!< Atten end (use that as a range for non-dir lights)		[Animatable]
    char mDecayType;           //!< Light's decay type
    float mHotSpot;            //!< Light's hotspot
                               //!< [Animatable]
    float mFallsize;           //!< Light's falloff
                               //!< [Animatable]
    float mAspect;             //!< Light's aspect
                               //!< [Animatable]
    ...
    float mRayBias;            //!< Raytrace bias
                               //!< [Animatable]
    float mMapBias;            //!< Map bias
                               //!< [Animatable]
    float mMapRange;           //!< Map range
                               //!< [Animatable]
    long mMapSize;             //!< Map size
                               //!< [Animatable]
    bool mCastShadows;         //!< Cast shadows
    float mShadowDensity;      //!< Shadow density
                               //!< [Animatable]
    Point mShadowColor;        //!< Shadow color
                               //!< [Animatable]
...
public:
    ...
    bool HasExtendedSelfIllum() const {
        if (mSelfIllumOn || IR(mSelfIllumValue) || IR(mSelfIllumColor.x) || IR(mSelfIllumColor.y) ||
    ...
    sdword mDisplacementMapID;         //!< Displacement texture map
                                       // Amounts
    float mAmbientCoeff;               //!< Ambient texture %
                                       //!< [Animatable]
    float mDiffuseCoeff;               //!< Diffuse tetxure %
                                       //!< [Animatable]
    float mSpecularCoeff;              //!< Specular texture %
                                       //!< [Animatable]
    float mShininessCoeff;             //!< Shininess texture % [Animatable]
    float mShiningStrengthCoeff;       //!< Shining Strength texture %
                                       //!< [Animatable]
    float mSelfIllumCoeff;             //!< Self Illum texture % [Animatable]
    float mOpacityCoeff;               //!< Opacity texture %
                                       //!< [Animatable]
    float mFilterCoeff;                //!< Filter texture % [Animatable]
    float mBumpCoeff;                  //!< Bump texture %
                                       //!< [Animatable]
    float mReflexionCoeff;             //!< Reflexion texture % [Animatable]
    float mRefractionCoeff;            //!< Refraction texture % [Animatable]
    float mDisplacementCoeff;          //!< Displacement texture %
                                       //!< [Animatable]
                                       // Colors
    Point mMtlAmbientColor;            //!< Ambient Color
                                       //!< [Animatable]
    Point mMtlDiffuseColor;            //!< Diffuse Color
                                       //!< [Animatable]
    Point mMtlSpecularColor;           //!< Specular Color
                                       //!< [Animatable]
    Point mMtlFilterColor;             //!< Filter Color
                                       //!< [Animatable]
                                       // Static properties
    ...
    float mBounce;                 //!< Bounce
                                   //!< [Animatable]
    float mStaticFriction;         //!< Static Friction
                                   //!< [Animatable]
    float mSlidingFriction;        //!< Sliding Friction
                                   //!< [Animatable]
...
private:
    ...
    bool ImportCroppingValues(TextureCrop& cvalues,
                              TextureMatrix& tmtx,
