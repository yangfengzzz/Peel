...
ScreenQuadColorGradient::ScreenQuadColorGradient(const Point& top_color, const Point& bottom_color)
    : mTopColor(top_color), mBottomColor(bottom_color), mID(INVALID_ID) {}
...
void ScreenQuadColorGradient::Apply(udword screen_width, udword screen_height) {
    ...
    GLRenderHelpers::DrawRectangle(0.0f, 1.0f, 0.0f, 1.0f, mBottomColor, mTopColor, 1.0f, screen_width, screen_height,
                                   false, GLRenderHelpers::SQT_DISABLED);
}
