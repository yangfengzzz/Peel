...
bool RenderModel_FFP::Close() { return true; }

IceWindow* RenderModel_FFP::InitGUI(IceWidget* parent, Widgets* owner, PintGUIHelper& helper) { return null; }

bool RenderModel_FFP::HasSpecialGroundPlane() const { return false; }
...
PintShapeRenderer* RenderModel_FFP::_CreateMeshRenderer(const PintSurfaceInterface& surface,
                                                        const Point* normals,
                                                        bool active_edges,
                                                        bool direct_data) {
...
PintShapeRenderer* RenderModel_FFP::_CreateMeshRenderer(const MultiSurface& multi_surface,
                                                        bool active_edges,
                                                        bool direct_data) {
    return CreatePintDLMeshShapeRenderer(multi_surface, GetMeshFlags(active_edges, direct_data));
}

PintShapeRenderer* RenderModel_FFP::_CreateColorShapeRenderer(PintShapeRenderer* renderer,
