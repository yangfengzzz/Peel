...
void GLRenderStates::SetDefaultCullMode(CULLMODE cull_mode) { gDefaultCullMode = cull_mode; }
...
void GLRenderStates::SetDefaultRenderStates(bool flip_culling) {
    switch (gDefaultCullMode) {
        ...
        case CULL_CW:
            glEnable(GL_CULL_FACE);
            glCullFace(flip_culling ? GL_FRONT : GL_BACK);
            break;
        case CULL_CCW:
            glEnable(GL_CULL_FACE);
            glCullFace(flip_culling ? GL_BACK : GL_FRONT);
            break;
    }
}
