...
void glutxMotionFunc(GlutX_MotionCallback cb) {
    glutMotionFunc(cb);
...
static void _KeyboardDownCallback(unsigned char key, int x, int y) {
    if (gUserKeyboardCB) (gUserKeyboardCB)(key, x, y, true);
}
static void _KeyboardUpCallback(unsigned char key, int x, int y) {
    if (gUserKeyboardCB) (gUserKeyboardCB)(key, x, y, false);
}
...
static void _SpecialKeyDownCallback(int key, int x, int y) {
    if (gUserSpecialKeyCB) (gUserSpecialKeyCB)(key, x, y, true);
}
static void _SpecialKeyUpCallback(int key, int x, int y) {
    if (gUserSpecialKeyCB) (gUserSpecialKeyCB)(key, x, y, false);
}
