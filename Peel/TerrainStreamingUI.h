...
public:
    ...
    inline_ bool DrawStreamingRegions() const {
        return mCheckBox_DrawStreamingRegions && mCheckBox_DrawStreamingRegions->IsChecked();
    }
    inline_ bool DrawVertexNormals() const {
        return mCheckBox_DrawVertexNormals && mCheckBox_DrawVertexNormals->IsChecked();
    }
    inline_ bool DrawWheelOverlapSpheres() const {
        return mCheckBox_DrawWheelOverlapSpheres && mCheckBox_DrawWheelOverlapSpheres->IsChecked();
    }
    inline_ bool DeformTerrain() const { return mCheckBox_DeformTerrain && mCheckBox_DeformTerrain->IsChecked(); }
    inline_ bool CreateAllInitialTiles() const {
        return mCheckBox_CreateAllInitialTiles && mCheckBox_CreateAllInitialTiles->IsChecked();
    }
