...
static void Init() {
    ...
    for (udword i = 0; i < 32; i++) P.Smooth(PIXEL_A);
    /*
...
void DrawRoundCorners(udword screen_width, udword screen_height, udword corner_size) {
    ...
    GLRenderHelpers::DrawRectangle(0.0f, 1.0f - x, y, 1.0f, color, color, Alpha, screen_width, screen_height, false,
                                   GLRenderHelpers::SQT_TEXTURING | GLRenderHelpers::SQT_FLIP_U);
    GLRenderHelpers::DrawRectangle(x, 1.0f, 0.0f, 1.0f - y, color, color, Alpha, screen_width, screen_height, false,
                                   GLRenderHelpers::SQT_TEXTURING | GLRenderHelpers::SQT_FLIP_V);
    GLRenderHelpers::DrawRectangle(
            0.0f, 1.0f - x, 0.0f, 1.0f - y, color, color, Alpha, screen_width, screen_height, false,
