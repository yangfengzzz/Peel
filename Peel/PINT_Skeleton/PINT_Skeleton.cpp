...
udword SkeletonPint::Update(float dt) { return 0; }

Point SkeletonPint::GetMainColor() { return Point(0.0f, 0.0f, 0.0f); }

void SkeletonPint::Render(PintRender& renderer, PintRenderPass render_pass) {}

void SkeletonPint::RenderDebugData(PintRender& renderer) {}

PintActorHandle SkeletonPint::CreateObject(const PINT_OBJECT_CREATE& desc) { return null; }

bool SkeletonPint::ReleaseObject(PintActorHandle handle) { return false; }

PintJointHandle SkeletonPint::CreateJoint(const PINT_JOINT_CREATE& desc) { return null; }
...
SkeletonPint* GetSkeleton() { return gSkeleton; }

///////////////////////////////////////////////////////////////////////////////

static Widgets* gSkeletonGUI = null;
...
void Skeleton_CloseGUI() { Common_CloseGUI(gSkeletonGUI); }
