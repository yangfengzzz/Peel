...
//	FILE* fp = fopen("d:\\rays.txt", "w");
        ...
        //			fprintf(fp, "%f\n", MaxDist*Scale);
                                ...
                                {
                                        const Point Extents(RayData.m_Extents.x, RayData.m_Extents.y,
RayData.m_Extents.z); const OBB Box(Origin, Extents, Idt); test.RegisterBoxSweep(Box, Dir, MaxDist*Scale);
                                }
                        }
                }
        }
...
RayData.m_Extents.y*Scale); const OBB Box(Origin, Extents, Idt); test.RegisterBoxSweep(Box, Dir, MaxDist*Scale);
                                }
                        }
                }
        }
