...
public:
    ...
    virtual IceLabel* CreateLabel(
            IceWidget* parent, sdword x, sdword y, sdword width, sdword height, const char* label, Widgets* owner);
    virtual IceCheckBox* CreateCheckBox(IceWidget* parent,
                                        udword id,
                                        sdword x,
                                        sdword y,
                                        sdword width,
    ...
    virtual IceEditBox* CreateEditBox(IceWidget* parent,
                                      udword id,
                                      sdword x,
                                      sdword y,
                                      sdword width,
                                      ...
                                      EBCallback callback,
                                      const char* tooltip = null);
    virtual IceButton* CreateButton(IceWidget* parent,
                                    udword id,
                                    sdword x,
                                    sdword y,
                                    sdword width,
...
PintGUIHelper* GetGUIHelper() { return &gGUIHelper; }
...
IceLabel* GUI_CreateLabel(
    ...
    if (owner) owner->Register(Label);
    return Label;
}

IceCheckBox* GUI_CreateCheckBox(IceWidget* parent,
                                udword id,
                                sdword x,
                                sdword y,
                                sdword width,
    ...
    CB->SetVisible(true);
    if (owner) owner->Register(CB);

    if (tooltip) CB->AddToolTip(tooltip);

    return CB;
}

IceEditBox* GUI_CreateEditBox(IceWidget* parent,
                              udword id,
                              sdword x,
                              sdword y,
                              sdword width,
    ...
    EB->SetVisible(true);
    if (owner) owner->Register(EB);

    if (tooltip) EB->AddToolTip(tooltip);

    return EB;
}

IceButton* GUI_CreateButton(IceWidget* parent,
                            udword id,
                            sdword x,
                            sdword y,
                            sdword width,
...
IceLabel* GUIHelper::CreateLabel(
        IceWidget* parent, sdword x, sdword y, sdword width, sdword height, const char* label, Widgets* owner) {
    return GUI_CreateLabel(parent, x, y, width, height, label, owner);
}

IceCheckBox* GUIHelper::CreateCheckBox(IceWidget* parent,
                                       udword id,
                                       sdword x,
                                       sdword y,
                                       sdword width,
...
IceEditBox* GUIHelper::CreateEditBox(IceWidget* parent,
                                     udword id,
                                     sdword x,
                                     sdword y,
                                     sdword width,
...
IceButton* GUIHelper::CreateButton(IceWidget* parent,
                                   udword id,
                                   sdword x,
                                   sdword y,
                                   sdword width,
