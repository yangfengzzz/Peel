...
public:
    ...
    inline_ bool HasSelection() const { return mSelection.GetNbEntries() != 0; }
    ...
    inline_ const SelectedObject* GetSelection() const { return (const SelectedObject*)mSelection.GetEntries(); }

    inline_ SelectedObject* GetSelection() { return (SelectedObject*)mSelection.GetEntries(); }
    ...
    //} 		inline_	void							LockSelection(bool b)
    //{ mLockSelection = b;		}
