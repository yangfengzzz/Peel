...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Cuts a tri-surface by a given plane. This method splits the source surface into two (positive and negative)
     *sub-surfaces. \param		cut_plane			[in] plane equation \param
     *positive_surface	[in] the positive destination surface (or null) \param		negative_surface [in] the
     *negative destination surface (or null)
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool Cut(const Plane& cut_plane,
             TriSurface* positive_surface,
             TriSurface* negative_surface,
             Container* positive_indices = null,
             Container* negative_indices = null) const;
...
public:
    ...
    bool Cut(const Plane& cut_plane,
             FatTriSurface* positive_surface,
             FatTriSurface* negative_surface,
             Container* positive_indices = null,
             Container* negative_indices = null) const;
