...
#endif
    //		udword			OptimizeFlags;			//!< A combination of VertexCode flags, to enable/disable
    //passes
...
//
// 1) First method:
// - convert your colors to RGBA *udwords* (since that's what will eventually be in your vertex buffers there's no real
// loss of precision...)
...
//
// It works since I actually only work on the binary representation of the float values without really doing any
// computation. Here I once again appreciate the power of radix-sort ! With a standard comparison-based sort, as the
// name suggests, real FPU comparisons would have been made while reducing the cloud, and it probably would have failed
// since some "floats" would've been read as NaNs or other non-valid float
// representations..............................................
//
// 2) Second method:
...
private:
    ...
    Container mArraySubmeshProperties;  //!< Array to store submesh properties: material ID, smoothing groups,
