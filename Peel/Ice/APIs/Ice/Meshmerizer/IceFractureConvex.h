...
public:
    ...
    FractureConvex(udword numVertices,
                   const Point* vertices,
                   udword numFaces,
                   const udword* indices,
                   const Matrix4x4* trans = null);
    ...
    void Init(
            udword numVertices, const Point* vertices, udword numFaces, const udword* indices, const Matrix4x4* trans);
...
private:
    ...
    bool cut(const Point& localPlaneN,
             float localPlaneD,
             FractureConvex*& c0,
             FractureConvex*& c1,
             bool selfCut,
             bool& selfCutEmpty);
    bool cut2(const Point& localPlaneN,
              float localPlaneD,
              FractureConvex*& c0,
              FractureConvex*& c1,
              bool selfCut,
