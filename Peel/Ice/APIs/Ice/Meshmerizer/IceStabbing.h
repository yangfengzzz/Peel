...
public:
    ...
    inline_ void SetBarycentricFirstPoint() {
        mU = 0.0f;
        mV = 0.0f;
    }
    inline_ void SetBarycentricSecondPoint() {
        mU = 1.0f;
        mV = 0.0f;
    }
    inline_ void SetBarycentricThirdPoint() {
        mU = 0.0f;
        mV = 1.0f;
    }
...
public:
    ...
    inline_ void AddStabbedFace(const StabbedFace& face) {
        Add((const udword*)&face, sizeof(StabbedFace) / sizeof(udword));
    }
