...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Subdivides a surface, regardless of the subdivision scheme. This is a generic subdivision process: for each
     *triangle we create four new triangles, and three new vertices along the three edges of the triangle. New vertices
     *are cached so that the subdividers are only called once per edge. After the call, the input surface is updated
     *with the new one. \param		surface		[in] the surface to subdivide.
     *	\param		use_cache	[in] true to cache computed vertices and only call the subdividers once per edge, else
     *always call them three times per triangle \param		history		[out] subdivision history (or null)
...
protected:
    ...
    virtual bool ComputeNewVertex(
            udword face_id, udword vref0, udword vref1, Point& p, SubdivHistory* history = null) = 0;
};
...
public:
    ...
    //} 		inline_					float				GetDisplacement()
    //const	{ return mDisplacement;		}
