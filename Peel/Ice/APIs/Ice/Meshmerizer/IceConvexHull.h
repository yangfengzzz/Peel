...
public:
    ...
    /*		inline_	const	udword*				GetPolygonData()		const
                                                                                            {
                                                                                                    if(!mPolygonData)
       const_cast<ConvexHull* const>(this)->CreatePolygonData();	// "mutable method" return mPolygonData;
                                                                                            }*/
 ...
 *	\param		polygon_data	[out] polygon data: (Nb indices, index 0, index 1... index N)(Nb indices, index
 *0, index 1... index N)(...) \param		hull			[in] convex hull \return		true if
 *success
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
