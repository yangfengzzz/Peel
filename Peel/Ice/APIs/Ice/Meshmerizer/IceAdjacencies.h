...
typedef void (*WALK_CALLBACK)(
        const CommonWalkParams& cwp, udword cur_face, udword prev_face, udword crossed_edge, udword prev_edge);
...
#endif
    //		private:
    //! Links/References of adjacent triangles. The 2 most significant bits contains the counterpart edge in the
    //! adjacent triangle. mATri[0] refers to edge 0-1 mATri[1] refers to edge 0-2 mATri[2] refers to edge 1-2
    udword mATri[3];
};
