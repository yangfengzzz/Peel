...
public:
    ...
    //				bool				Init(IndexedSurface* surface, Adjacencies* adj, udword nbbits, bool refpredictor, bool
    //compression);
...
private:
    ...
    void PredictPoint(
            const sdword* quantized, udword vref_last, udword vref0, udword vref1, sdword& x, sdword& y, sdword& z);
};
