...
public:
    ...
    bool ProgressiveMesh(udword nbverts,
                         const Point* verts,
                         udword nbfaces,
                         const IndexedTriangle* faces,
                         Container& map,
...
MESHMERIZER_API bool PermuteVertices(udword nbverts,
                                     const Container& permutation,
                                     ubyte* verts,
                                     udword vertexsize,
                                     udword nbfaces,
                                     udword* dtri,
                                     uword* wtri,
                                     udword minref);
MESHMERIZER_API udword BuildPM(udword render_num,
                               const udword* collapse_map,
                               udword nbfaces,
                               const udword* dfaces,
                               const uword* wfaces,
                               Container& mesh,
