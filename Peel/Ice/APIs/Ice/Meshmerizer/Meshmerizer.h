...
#ifdef _WIN64
#ifdef _DEBUG
#pragma comment(lib, "Meshmerizer64_D.lib")
#pragma comment(lib, "Contact64_D.lib")
#else
#pragma comment(lib, "Meshmerizer64.lib")
#pragma comment(lib, "Contact64.lib")
#endif
#else
#ifdef _DEBUG
