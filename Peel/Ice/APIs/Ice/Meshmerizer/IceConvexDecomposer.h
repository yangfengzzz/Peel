...
private:
    ...
    //				udword					mNbConnectedFaces;		//!< Number of connected faces for current
    //submesh
...
FUNCTION MESHMERIZER_API unsigned int Triangulate3d(
        unsigned int pcount,     // number of points in the polygon
