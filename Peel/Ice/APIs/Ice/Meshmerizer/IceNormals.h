 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION MESHMERIZER_API bool ComputePatchNormals(
        Point* normals, udword nbu, udword nbv, const Point* verts, udword mode, bool normalize = true);

// Normal packing/unpacking
FUNCTION MESHMERIZER_API void QuantizeNormal(
        float nx, float ny, float nz, long& sextant, long& octant, long& qphi, long& qtheta, unsigned char nb_bits = 5);
FUNCTION MESHMERIZER_API void DequantizeNormal(
        long sextant, long octant, long qphi, long qtheta, float& nx, float& ny, float& nz, unsigned char nb_bits = 5);
...
MESHMERIZER_API bool BuildSmoothNormals(udword nb_tris,
                                        udword nb_verts,
                                        const Point* verts,
                                        const udword* dfaces,
                                        const uword* wfaces,
