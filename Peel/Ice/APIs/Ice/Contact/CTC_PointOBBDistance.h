...
CONTACT_API float PointOBBSqrDist(
        const Point& point, const Point& center, const Point& extents, const Matrix3x3& rot, Point* params = null);

// Point-OBB distance
inline_ float PointOBBDist(
        const Point& point, const Point& center, const Point& extents, const Matrix3x3& rot, Point* params = null) {
