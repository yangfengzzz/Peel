...
CONTACT_API bool SweepSphereTriangles(udword nb_tris,
...
CONTACT_API bool SweepSphereTriangles2(udword nb_tris,
                                       const Triangle* triangles,
...
#ifdef OLDIES
CONTACT_API bool SweepTriSphere(
        const Triangle& tri, const Sphere& sphere, const Point& dir, float& min_dist, Point& normal);
CONTACT_API bool SweepSphereTriangles(udword nb_tris,
                                      const Triangle* triangles,
                                      const Point& center,
                                      const float radius,
