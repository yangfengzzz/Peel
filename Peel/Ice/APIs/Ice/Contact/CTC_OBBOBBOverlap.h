...
CONTACT_API bool OBBOBBOverlap(const Point& e0,
                               const Point& c0,
                               const Matrix3x3& r0,
                               const Point& e1,
                               const Point& c1,
...
CONTACT_API int OBBOBBOverlap(Point& res_normal,
                              Point& res_point,
...
CONTACT_API int testintersect_box_box(Point hitpos[16],
                                      float penedist[16],
                                      Point* hitnrm,
                                      const Point& c0,
                                      const Point& e0,
...
inline_ int OBBOBBOverlap(
        Point& res_normal, Point& res_point, float& res_penetration, const OBB& box0, const OBB& box1) {
    return Ctc::OBBOBBOverlap(res_normal, res_point, res_penetration, box0.mCenter, box0.mExtents, box0.mRot,
                              box1.mCenter, box1.mExtents, box1.mRot);
}

inline_ int testintersect_box_box(
        Point hitpos[16], float penedist[16], Point* hitnrm, const OBB& box0, const OBB& box1) {
    return Ctc::testintersect_box_box(hitpos, penedist, hitnrm, box0.mCenter, box0.mExtents, box0.mRot, box1.mCenter,
                                      box1.mExtents, box1.mRot);
}

inline_ bool OBBOBBOverlap(const OBB& obb0, const OBB& obb1, bool full_test = true) {
    return Ctc::OBBOBBOverlap(obb0.mExtents, obb0.mCenter, obb0.mRot, obb1.mExtents, obb1.mCenter, obb1.mRot,
                              full_test);
}
...
CONTACT_API SepAxis SeparatingAxis(const Point& e0,
                                   const Point& c0,
                                   const Matrix3x3& r0,
                                   const Point& e1,
                                   const Point& c1,
...
inline_ SepAxis SeparatingAxis(const OBB& obb0, const OBB& obb1, bool full_test = true) {
    return Ctc::SeparatingAxis(obb0.mExtents, obb0.mCenter, obb0.mRot, obb1.mExtents, obb1.mCenter, obb1.mRot,
                               full_test);
}
