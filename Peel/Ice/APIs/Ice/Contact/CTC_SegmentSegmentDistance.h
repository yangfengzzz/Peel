...
inline_ float SegmentSegmentSqrDist(const Point &seg0_p0,
                                    const Point &seg0_p1,
                                    const Point &seg1_p0,
                                    const Point &seg1_p1,
                                    float *s = null,
...
CONTACT_API void IntersectLineSegments(const float A1x,
                                       const float A1y,
                                       const float A1z,
                                       const float A2x,
                                       const float A2y,
                                       ...
                                       float &NearestPointY,
                                       float &NearestPointZ,
                                       float &NearestVectorX,
                                       float &NearestVectorY,
                                       float &NearestVectorZ,
                                       bool &true_intersection);

CONTACT_API void FindNearestPointOnLineSegment(const float A1x,
                                               const float A1y,
                                               const float A1z,
                                               const float Lx,
                                               const float Ly,
...
CONTACT_API void FindNearestPointOfParallelLineSegments(float A1x,
                                                        float A1y,
                                                        float A1z,
                                                        float A2x,
                                                        float A2y,
...
CONTACT_API void AdjustNearestPoints(float A1x,
                                     float A1y,
                                     float A1z,
                                     float Lax,
                                     float Lay,
