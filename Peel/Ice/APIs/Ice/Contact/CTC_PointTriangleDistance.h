...
CONTACT_API float PointTriangleSqrDist(
        const Point& point, const Point& p0, const Point& p1, const Point& p2, float* u = null, float* v = null);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ float PointTriangleDist(
        const Point& point, const Point& p0, const Point& p1, const Point& p2, float* u = null, float* v = null) {
    return sqrtf(PointTriangleSqrDist(point, p0, p1, p2, u, v));
}

inline_ float PointTriangleSqrDist(
        const Point& point, const IndexedTriangle& triangle, const Point* verts, float* u = null, float* v = null) {
    return Ctc::PointTriangleSqrDist(point, verts[triangle.mRef[0]], verts[triangle.mRef[1]], verts[triangle.mRef[2]],
                                     u, v);
}

inline_ float PointTriangleDist(
        const Point& point, const IndexedTriangle& triangle, const Point* verts, float* u = null, float* v = null) {
    return Ctc::PointTriangleDist(point, verts[triangle.mRef[0]], verts[triangle.mRef[1]], verts[triangle.mRef[2]], u,
                                  v);
}
