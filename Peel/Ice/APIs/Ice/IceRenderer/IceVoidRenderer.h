...
public:
    ...
    // Primitive rendering
    override(Renderer) bool DrawPrimitive(
            PrimType type, VertexFormat fvf, const void* verts, udword nbvertices, udword flags = 0);
    override(Renderer) bool DrawIndexedPrimitive(PrimType type,
                                                 VertexFormat fvf,
                                                 const void* verts,
                                                 udword nbvertices,
                                                 const uword* indices,
    ...
    override(Renderer) bool DrawPrimitiveVB(
            PrimType type, VertexBuffer* vb, udword startvertex, udword nbvertices, udword flags = 0);
    override(Renderer) bool DrawIndexedPrimitiveVB(PrimType type,
                                                   VertexBuffer* vb,
                                                   udword startvertex,
                                                   udword nbvertices,
                                                   const uword* indices,
