...
public:
    ...
    inline_ Billboard(const Point& p, float s, float d, udword c)
        : mPos(p), mSize(s), mDeadLine(d), mColor(c), mFlags(0) {}
    inline_ ~Billboard() {}
...
public:
     ...
     *	\param		global_time	[in] current global time. Use default param for permanent (non-fading)
     *billboards. \param		fade_length	[in] length of fade for all billboards \return		true if
     *success
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    inline_ void SetWorldMatrix(const Matrix4x4& world_matrix) {
        mWorld = world_matrix;
        mIdentity = mWorld.IsIdentity();
    }
...
public:
    ...
    inline_ FXQuad(const Point& p0, const Point& p1, const Point& p2, const Point& p3, float deadline)
        : mP0(p0), mP1(p1), mP2(p2), mP3(p3), mDeadLine(deadline), mFlags(0) {}
    inline_ ~FXQuad() {}
