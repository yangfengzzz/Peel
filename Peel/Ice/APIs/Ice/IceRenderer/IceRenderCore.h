...
public:
    ...
    inline_ Renderer& AddTriangle(const Triangle& tri, udword color = ARGB_WHITE) {
        AddTriangle(tri.mVerts[0], tri.mVerts[1], tri.mVerts[2], color);
        return *this;
    }
    ...
    void ComputeScreenQuad(const ViewMatrix& inverse_view,
                           ...
                           const Point& p1,
                           float size,
                           bool constant_size) const;
    void ComputeArrowPoints(const ViewMatrix& inverse_view,
                            const ViewMatrix& view,
                            const ProjMatrix& proj,
                            const Point& p0,
                            const Point& p1,
    ...
    virtual bool DrawPrimitive(
            PrimType type, VertexFormat fvf, const void* verts, udword nb_verts, udword flags = 0) = 0;
    virtual bool DrawIndexedPrimitive(PrimType type,
                                      VertexFormat fvf,
                                      const void* verts,
                                      udword nb_verts,
                                      const uword* indices,
    ...
    virtual bool DrawPrimitiveVB(
            PrimType type, VertexBuffer* vb, udword start_vertex, udword nb_verts, udword flags = 0) = 0;
    virtual bool DrawIndexedPrimitiveVB(PrimType type,
                                        VertexBuffer* vb,
                                        udword start_vertex,
                                        udword nb_verts,
                                        const uword* indices,
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Gets the general renderer caps. Don't take the caps as granted! you're supposed to check them before using any
     *of them! \return		true if success
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    virtual Texture* CreateCompressedTexture(const char* filename) { return null; }
    ...
    virtual BOOL SetVertexShaderConstantB(udword start_register, const BOOL* constant_data, udword bool_count) {
        return FALSE;
    }
    virtual BOOL SetVertexShaderConstantF(udword start_register, const float* constant_data, udword vector_4f_count) {
        return FALSE;
    }
    virtual BOOL SetVertexShaderConstantI(udword start_register, const udword* constant_data, udword vector_4i_count) {
        return FALSE;
    }
    virtual BOOL SetPixelShaderConstantB(udword start_register, const BOOL* constant_data, udword bool_count) {
        return FALSE;
    }
    virtual BOOL SetPixelShaderConstantF(udword start_register, const float* constant_data, udword vector_4f_count) {
        return FALSE;
    }
    virtual BOOL SetPixelShaderConstantI(udword start_register, const udword* constant_data, udword vector_4i_count) {
        return FALSE;
    }
    virtual void SetupTestPS() {}

    // Render states
    void SetRSCheckings(bool flags) {
        if (mRS) mRS->SetCheckings(flags);
    }
    void SetRSUpdateLog(bool flags) {
        if (mRS) mRS->SetUpdateLog(flags);
    }
    ...
    /*		// Lighting
                    virtual			bool				SetLight(udword lightindex, Light* light)			=
       0; virtual			bool				GetLight(udword lightindex, Light* light)
       = 0;
                    virtual			bool				GetLightEnable(udword lightindex, udword* enable)	=
       0; virtual			bool				LightEnable(udword lightindex, bool enable)
       = 0;*/
    // Lighting code
    ...
    //		virtual			bool				GetLightEnable(udword lightindex, udword*
    //enable);
