...
public:
     ...
     *	This is a generic method, working for skinning, morphing, etc. It can be slower than a dedicated method (for
     *example you can skin your normals as well as vertices for characters)
     *
