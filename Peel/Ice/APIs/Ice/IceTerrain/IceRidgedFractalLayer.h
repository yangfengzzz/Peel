...
public:
    ...
    inline_ void SetOffsetX(float offset) {
        mOffsetX = offset;
        MarkDirty();
    }
    inline_ void SetOffsetY(float offset) {
        mOffsetY = offset;
        MarkDirty();
    }
    inline_ void SetXFreq(float freq) {
        mXFreq = freq;
        MarkDirty();
    }
    inline_ void SetYFreq(float freq) {
        mYFreq = freq;
        MarkDirty();
    }
    inline_ void SetZ(float z) {
        mZ = z;
        MarkDirty();
    }
    ...
    inline_ void SetGain(float gain) {
        mRidged.SetGain(gain);
        MarkDirty();
    }
    inline_ void SetOffset(float offset) {
        mRidged.SetOffset(offset);
        MarkDirty();
    }
