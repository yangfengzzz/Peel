...
// A time segment deals with frame numbers (integers) because it does not depends on mDeltaTM (i.e. arbitrary delay
// between frames)
...
#endif
//		inline_	MotionCell*			GetSourceCell()				const	{ return
//mSourceMotionCell;						}
...
#ifndef SUPPORT_NEW_DESIGN
    /* State */ udword
            mTrustLevel;  //!< From 0 to mEvent.NbBasicEvents. Transition is valid when reaching mEvent.NbBasicEvents.
#endif
    ubyte mPriority;
    //				ubyte				mFlushEvents;
