...
public:
     ...
     *	\param		id		[in] menu ID (selected menu item), or INVALID_ID if the plug-in's name has been
     *selected \return		true if success \see		GetMenuHandle()
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Gets supported file extensions for loading. It is possible to return several extensions, separated by a white
     *space. \return		supported file extensions (ex: "bmp", "bmp tga", etc), null if import is not supported
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Gets supported file extensions for saving. It is possible to return several extensions, separated by a white
     *space. \return		supported file extensions (ex: "bmp", "bmp tga", etc), null if export is not supported
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    virtual bool Decompress(ubyte* dest,
                            udword& original_size,
                            const void* compressed_buffer,
                            udword compressed_size) = 0;
};

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Compresses a buffer. This method needs registered compression plug-ins.
 *	\fn			Compress(ubyte* dest, udword& dest_size, const void* source, udword source_size, const
 *char* method) \param		dest		[out] destination (compressed) buffer
 *	\param		dest_size	[out] size of compressed buffer
 *	\param		source		[in] source (input) buffer
 *	\param		source_size	[in] size of source buffer
 *	\param		method		[in] method to use for compression. If no method specified (null), try all
 *available methods and keep the best. \return		name of used method, null if failed
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION FLEXINE_API const char* Compress(
        ubyte* dest, udword& dest_size, const void* source, udword source_size, const char* method = null);

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Decompresses a buffer. This method needs registered compression plug-ins.
 *	\fn			Decompress(ubyte* dest, udword& original_size, const void* compressed_buffer, udword
 *compressed_size, const char* method) \param		dest				[out] destination (decompressed)
 *buffer \param		original_size		[out] size of decompressed buffer (shoul be the original size of source
 *buffer) \param		compressed_buffer	[in] source (compressed) buffer \param
 *compressed_size		[in] size of source buffer
 *	\param		method				[in] method to use for decompression. If null, try all of them.
 *	\return		name of used method, null if failed
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION FLEXINE_API const char* Decompress(ubyte* dest,
                                            udword& original_size,
                                            const void* compressed_buffer,
