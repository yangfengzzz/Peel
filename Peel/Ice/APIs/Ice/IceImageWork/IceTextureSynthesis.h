...
public:
    ...
    bool GrowImage(FloatPicture& sampleimage,
                   FloatPicture& weightimage,
                   FloatPicture& maskimage,
                   FloatPicture& resultimage);

protected:
    virtual bool SetProgress(float percent);
    bool CheckArguments(FloatPicture& sampleimage,
                        FloatPicture& weightimage,
                        FloatPicture& maskimage,
                        FloatPicture& resultimage);
    float SSD(FloatPicture& sampleimage,
              FloatPicture& weightimage,
              FloatPicture& maskimage,
              FloatPicture& resultimage,
              sdword samplerow,
              ...
              sdword resultrow,
              sdword resultcol);
    sdword FindMatches(FloatPicture& sampleimage,
                       FloatPicture& weightimage,
                       FloatPicture& maskimage,
                       FloatPicture& resultimage,
                       sdword row,
