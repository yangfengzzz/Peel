...
class ICEIMAGEWORK_API FntDataBase : public Allocateable {
public:
    FntDataBase();
    ~FntDataBase();
...
class ICEIMAGEWORK_API FntData : public FntDataBase {
public:
    FntData() {}
    ~FntData() {}
...
class ICEIMAGEWORK_API FntData2 : public FntDataBase {
public:
    FntData2() {}
    ~FntData2() {}
...
public:
    ...
    bool Init(const char* alphabet,
              udword text_size,
              udword texture_size,
              udword space_size,
              const char* fonts_name = null);
...
FUNCTION ICEIMAGEWORK_API bool CreateFntData(Picture& src,
                                             Container& fnt_uvs,
                                             udword tex_size,
                                             udword space_size,
                                             udword& fnt_width,
...
FUNCTION ICEIMAGEWORK_API bool RenderText(const String& msg,
                                          Picture& pic,
                                          sdword size,
                                          const RGBPixel& bk_color,
                                          const RGBPixel& text_color,
                                          udword extra_space,
                                          const char* fonts_name = null,
                                          HFONT* fonts = null);

class ICEIMAGEWORK_API Fonts2 : public Allocateable {
public:
    Fonts2() {}
    ~Fonts2() {}
    ...
    inline_ const Picture& GetPicture() const { return mSrc; }
    inline_ const FntData2& GetFntData() const { return mData; }
