...
/*
                                Pivot				mPivot;					//!< Pivot
   information [Flexporter 1.15] const ubyte*		mUserProps;				//!< User-defined
   properties JointDescriptor*	mIKData;				//!< IK data [Flexporter 1.15]
                // User-defined physics properties
                                float				mDensity;				//!< Object's
   density [Flexporter 1.16]
                                float				mMass;					//!< Object's
   mass [Flexporter 1.16] sdword				mSamplingDensity;		//!< Sampling rate
   [Flexporter 1.16] bool				mResetPivot;			//!< [Flexporter 1.16] bool
   mIsCollidable;			//!< [Flexporter 1.16]
                                bool				mLockPivot;				//!< Lock pivot
   point or not [Flexporter 1.16]
*/
