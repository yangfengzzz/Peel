...
class ZCB2_API MATLChunk : public ROBJChunk {
    ...
    //} 		inline_	sdword				GetReflexionMapID()
    //const	{ return mReflexionMapID;							} 		inline_	void
    //GetMaterialProps(MaterialProps& props)	const	{ props = mProps;
    //} 		inline_	CULLMODE			GetCullMode()
    //const	{ return mCullMode;									}
