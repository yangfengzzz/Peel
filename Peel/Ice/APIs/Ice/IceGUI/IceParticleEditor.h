...
public:
    ...
    virtual void OnChangedGraph(
            GraphCode graph_code, udword nb_keys, const Keyframe* keys, uword graph_width, uword graph_height) {}
    virtual void OnChangedPalette(const RGBAPalette* palette) {}
};

FUNCTION ICEGUI_API IceWindow* CreateParticleEditor(
        IceWidget* parent, sdword x, sdword y, sdword width, sdword height, ParticleEditorInterface* pei);
