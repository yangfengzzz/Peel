...
ICECORE_API bool ReadHeader(
        ubyte a_, ubyte b_, ubyte c_, ubyte d_, udword& version, bool& mismatch, const ReadStream& stream);
...
inline_ void Flip(sword& v) { Flip((uword&)v); }
...
inline_ void Flip(sdword& v) { Flip((udword&)v); }

inline_ void Flip(float& v) { Flip((udword&)v); }
