...
public:
    ...
    inline_ CustomArray& StoreBit(bool bit) {
        mBitMask <<= 1;          // Shift current bitmask
                                 //									if(bit)	mBitMask |= 1;		// Set the LSB if
                                 //needed
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ udword GetCellUsedSize() const { return mCurrentCell->Size; }
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ udword GetCellMaxSize() const { return mCurrentCell->Max; }
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ udword GetCellRemainingSize() const { return mCurrentCell->Max - mCurrentCell->Size; }
    ...
    uqword ReadQword() const;                          //!< Read a qword from the array
