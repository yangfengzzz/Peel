 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION ICECORE_API bool SetIceError_(const char* error,
                                       const char* error_code = null,
                                       bool update_log = true,
...
//
#define ICE_TRY \
    udword __RDTSEC = GetLastIceError() ? GetLastIceError()->mErrorTimeStamp : 0;  //!< Read time stamp error counter
#define ICE_CATCH \
    if (GetLastIceError() && GetLastIceError()->mErrorTimeStamp != __RDTSEC)  //!< Compare to previous counter
...
//			...
//		}
//		ICE_CATCH	// Here the error gets reported again, so the higher level gets a chance to handle the
//error.
//
...
//
#define ICE_RESOLVED \
    if (GetLastIceError()) ((IceError*)GetLastIceError())->mErrorTimeStamp = __RDTSEC;  //!<
