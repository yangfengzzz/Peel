...
#define _FIELD(type, name, fieldtype, count, flags, accessor, callback, user) \
    { fieldtype, #name, OFFSET_OF(type, name), count, flags, accessor, callback, user }

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//! Defines a single base field
#define DEFINE_FIELD(type, name, fieldtype, flags, accessor, callback) \
    _FIELD(type, name, fieldtype, 1, flags, accessor, callback, 0)
//! Defines a static array of base fields
#define DEFINE_FIELDS(type, name, fieldtype, count, flags, accessor, callback) \
    _FIELD(type, name, fieldtype, count, flags, accessor, callback, 0)
//! Defines a single custom field
#define DEFINE_USER_FIELD(type, name, fieldtype, flags, accessor, callback, user) \
    _FIELD(type, name, fieldtype, 1, flags, accessor, callback, user)
//! Defines a static array of custom fields
#define DEFINE_USER_FIELDS(type, name, fieldtype, count, flags, accessor, callback, user) \
    _FIELD(type, name, fieldtype, count, flags, accessor, callback, user)
//! Defines a dynamic array of base fields
#define DEFINE_ARRAY(type, name, fieldtype, flags, accessor, callback) \
    _FIELD(type, name, fieldtype, 0, flags, accessor, callback, 0)
//! Defines a dynamic array of custom fields
#define DEFINE_USER_ARRAY(type, name, fieldtype, flags, accessor, callback, user) \
    _FIELD(type, name, fieldtype, 0, flags, accessor, callback, user)

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//! Starts field declarations
#define BEGIN_FIELDS(current_class) \
    FieldDescriptor current_class::mClassDescriptor[] = {{FIELD_FORCE_DWORD, #current_class, 0, 0, 0, null, null, 0},
//! Ends field declarations
#define END_FIELDS(current_class) \
    }                             \
    ;                             \
    udword current_class::GetDescriptorSize() const { return ICE_ARRAYSIZE(mClassDescriptor); }
...
struct ICECORE_API FieldDescriptor {
    ...
    inline_ void* Address(void* class_ptr) const { return (void*)(size_t(class_ptr) + Offset); }
...
public:
    ...
    void AddDescriptor(const FieldDescriptor* descriptor) { mContainer.AddUnique(descriptor); }
