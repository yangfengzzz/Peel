...
inline_ float ice_log2(float f) { return logf(f) * INVLN2; }
...
inline_ udword CodeSize5(udword value) {
    return (value >= 0x80000000) + (value >= 0x40000000) + (value >= 0x20000000) + (value >= 0x10000000) +
           ...
           (value >= 0x800000) + (value >= 0x400000) + (value >= 0x200000) + (value >= 0x100000) + (value >= 0x80000) +
           (value >= 0x40000) + (value >= 0x20000) + (value >= 0x10000) + (value >= 0x8000) + (value >= 0x4000) +
           (value >= 0x2000) + (value >= 0x1000) + (value >= 0x800) + (value >= 0x400) + (value >= 0x200) +
           (value >= 0x100) + (value >= 0x80) + (value >= 0x40) + (value >= 0x20) + (value >= 0x10) + (value >= 0x8) +
           (value >= 0x4) + (value >= 0x2) + (value >= 0x1);
}
