...
public:
    ...
    // Callback control
    inline_ TextParser& SetUserData(void* user_data) {
        mUserData = user_data;
        return *this;
    }
    inline_ TextParser& SetCallback(PARSE_CALLBACK callback) {
        mCallback = callback;
        return *this;
    }
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef bool (*CMDPARSE_CALLBACK)(
...
public:
    ...
    inline_ String& GetParam(udword i) {
        ASSERT(i < mNbParams);
        return mTable[i];
    }
    inline_ const String& GetParam(udword i) const {
        ASSERT(i < mNbParams);
        return mTable[i];
    }
    inline_ String& operator[](udword i) const {
        ASSERT(i < mNbParams);
        return mTable[i];
    }
...
public:
    ...
    // Data access
    inline_ udword GetNbParams() const { return mNbParams; }
    inline_ const char* operator[](udword i) const {
        ASSERT(i < mNbParams);
        return mTable[i];
    }
...
public:
    ...
    bool RegisterCommand(const char* command,
                         CMDPARSE_CALLBACK callback = null,
                         udword context = 0,
...
public:
    ...
    // To overload
    virtual bool Execute(const char* source) {
        mParsingFlags &= ~BFC_COMMENTS_FLIPSTATUS;
        return true;
    }
...
private:
    ...
    ParameterBlock mPB;
    // Internal methods
    bool FindCommand(const char* buffer,
                     const CommandManager* cm,
                     const ParameterBlock& work,
                     bool& valid_command,
                     ParameterBlock*& cmd);
};
