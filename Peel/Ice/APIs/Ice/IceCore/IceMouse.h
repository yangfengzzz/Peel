...
enum MouseButton { MBT_LEFT = 0, MBT_MIDDLE = 1, MBT_RIGHT = 2 };
...
FUNCTION ICECORE_API void RepositionMouse(
        HWND handle, udword render_width, udword render_height, sdword& delta_mouse_x, sdword& delta_mouse_y);
...
struct ICECORE_API ScreenRect {
    ...
    bool IsEmpty() const { return ((mLeft == mRight) || (mBottom == mTop)); }
