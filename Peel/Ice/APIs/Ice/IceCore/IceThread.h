...
FUNCTION ICECORE_API IceMutex* CreateMutex_();
...
FUNCTION ICECORE_API IceSem* CreateSemaphore_(udword initial_value);
...
FUNCTION ICECORE_API IceThread* CreateThread_(int (*fn)(void*), void* data);
