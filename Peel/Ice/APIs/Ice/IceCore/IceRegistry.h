 ...
 *	\fn			Save(const char* app_name, const char* folder, const char* param_name, const String&
 *param) \param		app_name	[in] application's name, used to prevent name clash \param		folder
 *[in] a folder in the registry hierarchy, child of app_name
 *	\param		param_name	[in] name of the parameter, child of folder in the registry hierarchy
 *	\param		param		[in] parameter value to be saved
 *	\return		true if success
 */
 ...
 *	\fn			Save(const char* app_name, const char* folder, const char* param_name, const void* param,
 *udword size) \param		app_name	[in] application's name, used to prevent name clash
 *	\param		folder		[in] a folder in the registry hierarchy, child of app_name
 *	\param		param_name	[in] name of the parameter, child of folder in the registry hierarchy
 ...
 *	\fn			Load(const char* app_name, const char* folder, const char* param_name, void* param, udword&
 *size) \param		app_name	[in] application's name, used to prevent name clash \param		folder
 *[in] a folder in the registry hierarchy, child of app_name
 *	\param		param_name	[in] name of the parameter, child of folder in the registry hierarchy
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Adds a filename to a list of most recently used files. This list is automatically saved to registry and managed
 *by the framework. \fn			AddToRecentFiles(const char* filename)
