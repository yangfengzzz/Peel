...
public: /* Public interface */                                                               \
    ...
    inline_ udword Get##flag_type() const { return member; }                                 \
                                                                                             \
    /* Checks a particular flag is set or not */                                             \
    inline_ BOOL IsSet(flag_type flag) const { return member & flag; }                       \
                                                                                             \
...
protected: /* Protected interface, to setup read-only flags */                               \
    ...
    bool ForceSet(flag_type flag, bool b) {                                                  \
        if (b)                                                                               \
            return ForceEnable(flag);                                                        \
        else                                                                                 \
            return ForceDisable(flag);                                                       \
    }                                                                                        \
                                                                                             \
private:                                                                                     \
    udword member;                                                                           \
