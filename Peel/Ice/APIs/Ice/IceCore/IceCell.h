...
public:
    ...
    inline_ CellsContainer& AddCell(const Cell* cell) {
        mContainer.AddPtr(cell);
        return *this;
    }
...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Sets the cell's type. Despite it's a const char, you can use it as an ID by supplying addresses of fixed strings
     *in memory. This is the recommended way, since it provides best of both worlds:
    ...
    inline_ Cell& Enable(CellFlag flag) {
        m__Flags |= flag;
        return *this;
    }
    inline_ Cell& Disable(CellFlag flag) {
        m__Flags &= ~flag;
        return *this;
    }
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	The self-destruction method. The kernel always deletes cells indirectly, using this method. That way the app has
     *a way to definitely prevent the kernel from deleting cells, by overriding this method. This should not be needed
     *nonetheless. \param		context		[in] destruction context \param		user_data
     *[in] possible user-defined data \return		true if the cell has been deleted
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     *	\param		command		[in] the command to execute, or null. If null, EnumCommand gets called for each command
     *found. \param		user_data	[in] user-defined data, sent to EnumCommand if needed.
     *	\return		true if success
