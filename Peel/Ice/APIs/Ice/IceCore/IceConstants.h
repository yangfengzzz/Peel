...
public:
     ...
     *	\warning	do not modify a string (const access), as it would invalidate the sort and produce unpredictable
     *results
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ const Constant* GetConstants() {
        if (!mSorted) Sort();
        return (const Constant*)mContainer.GetEntries();
    }

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Adds a constant to the list. The list is searched for duplicate names, so this has the same running time as
     *Find(). \param		str			[in] constant's name
     *	\param		user_data	[in] constant's value
     *	\return		true if success
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool AddConstant(const char* str, void* user_data);
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool RemoveConstant(const char* str, void** user_data = null);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Finds a constant given its name. Lazy-sorts the list on-the-fly if needed. So O(log n) most of the time,
     *sometimes O(2*log n). \param		str			[in] constant's name
     *	\param		user_data	[out] constant's value, or null if not needed
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool Find(const char* str, void** user_data = null, udword* pos = null);
...
public:
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool Add(const char* str, void* user_data);
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool Find(const char* str, void** user_data = null);
