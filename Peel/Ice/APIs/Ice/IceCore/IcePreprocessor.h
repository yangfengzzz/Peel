...
/*		#pragma warning( disable : 4062 ) // enumerate 'xxx' in switch of enum 'xxx' is not handled.
                ...
                #pragma warning( disable : 4668 ) // xxx is not defined as a preprocessor macro, replacing with '0' for
   '#if/#elif'. #pragma warning( disable : 4710 ) // function not inlined. #pragma warning( disable : 4820 ) // 'x'
   bytes padding added after member xxx.
*/
