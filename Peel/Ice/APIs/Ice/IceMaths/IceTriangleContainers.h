...
public:
    ...
    void AddTriangle(const IndexedTriangle& tri) { Add(tri.mRef[0]).Add(tri.mRef[1]).Add(tri.mRef[2]); }

    void AddTriangle(udword vref0, udword vref1, udword vref2) { Add(vref0).Add(vref1).Add(vref2); }
};
