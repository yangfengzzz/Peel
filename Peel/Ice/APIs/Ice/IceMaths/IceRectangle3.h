...
public:
    ...
    inline_ Rectangle3() {}
    //! Constructor
    inline_ Rectangle3(const Point& orig, const Point& edge0, const Point& edge1)
        : mOrig(orig), mEdge0(edge0), mEdge1(edge1) {}
    //! Copy constructor
    inline_ Rectangle3(const Rectangle3& rectangle)
        : mOrig(rectangle.mOrig), mEdge0(rectangle.mEdge0), mEdge1(rectangle.mEdge1) {}
    //! Destructor
    inline_ ~Rectangle3() {}
