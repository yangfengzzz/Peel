///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	This file contains code to compute "screwings" (in St�phane Redon-parlance).
 *	\file		IceScrewing.h
...
public:
    ...
    inline_ float ComputeSquaredLength(const Point& world_pt) const {
        // taille du chemin h�lico�dal dl = sqrt(s^2 + w^2(x^2 + y^2) * dt
        // s,w = screwing params
        // x,y = coordonn�es de p dans le rep�re local du screwing
    ...
    inline_ float ComputeLength(const Point& world_pt) const { return sqrtf(ComputeSquaredLength(world_pt)); }
