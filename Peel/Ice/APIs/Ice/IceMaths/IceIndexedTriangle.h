...
public:
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    inline_ void Flip() { Swap(mRef[1], mRef[2]); }
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     *	Checks whether the triangle is degenerate or not. A degenerate triangle has two common vertex references. This
     *is a zero-area triangle. \return		true if the triangle is degenerate
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    inline_ Plane PlaneEquation(const Point* verts) const {
        return Plane(verts[mRef[0]], verts[mRef[1]], verts[mRef[2]]);
    }
...
public:
    ...
    //! Constructor
    inline_ IndexedTriangle16(uword r0, uword r1, uword r2) {
        mRef[0] = r0;
        mRef[1] = r1;
        mRef[2] = r2;
    }
