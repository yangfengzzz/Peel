...
public:
    ...
    inline_ Matrix4x4(IDENTITY) { Identity(); }
    ...
    inline_ void Set(const float* f) {
        Set(f[0], f[1], f[2], f[3], f[4], f[5], f[6], f[7], f[8], f[9], f[10], f[11], f[12], f[13], f[14], f[15]);
    }
    ...
    /*
                    ...
                    //! Sets a row.
                    inline_	Matrix4x4&	SetRow(const udword row, const HPoint& p)	{ mRow[row] = p;	return
       *this;										}
                    //! Sets a row.
    ...
    */
    ...
    inline_ HPoint operator*(const HPoint& v) const {
        return HPoint(GetRow(0) | v, GetRow(1) | v, GetRow(2) | v, GetRow(3) | v);
    }
 ...
 *
 *	\relates	Matrix4x4
 *	\fn			ComputePassageMatrices(const Matrix4x4* mat0, const Matrix4x4* mat1, const Matrix4x4*
 *mat0to1, const Matrix4x4* mat1to0) \param		mat0	[out] passage matrix from 0 to 1, null if not needed
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ICEMATHS_API void ComputePassageMatrices(Matrix4x4* mat0to1 = null,
                                         Matrix4x4* mat1to0 = null,
                                         const Matrix4x4* mat0 = null,
                                         const Matrix4x4* mat1 = null);
