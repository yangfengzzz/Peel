...
// Return the distance from the point p to the nth closest randomly distributed point defined by the noise function.
// Density sets how densely the noise points are in three-space.
