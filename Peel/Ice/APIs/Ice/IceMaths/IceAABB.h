...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    void SetEmpty() {
        Point p(MIN_FLOAT, MIN_FLOAT, MIN_FLOAT);
        mMin = -p;
        mMax = p;
    }
    ...
    //! Versions to return a reference, needed to avoid LHS in VMX code.
    inline_ const Point& GetMin() const { return mMin; }
    inline_ const Point& GetMax() const { return mMax; }
    ...
    //		private:	// Made public January 22, 2013. Considering the amount of code written with ICE_USE_MINMAX, we're
    //unlikely to change it now...
