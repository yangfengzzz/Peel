 ...
 *	\fn			GeneratePolygon(udword nb_verts, void* verts, udword stride, Orientation orientation, float
 *amplitude, float phase) \relates	Polygon \param		nb_verts	[in] number of vertices \param
 *verts		[out] generated vertices \param		stride		[in] stride between two vertices, in bytes
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ICEMATHS_API bool GeneratePolygon(
        udword nb_verts, void* verts, udword stride, Orientation orientation, float amplitude, float phase = 0.0f);

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Finds the plane equation of a polygon.
 *	\fn			CreatePolygonPlane(Plane& plane, udword nb_verts, const udword* indices, const Point*
 *verts) \relates	Polygon \param		plane		[out] plane equation
 ...
 *	\fn			ComputeNewellPlane(Plane& plane, udword nb_verts, const udword* indices, const Point*
 *verts) \relates	Polygon \param		plane		[out] plane equation
 *	\param		nb_verts	[in] number of vertices
 *	\param		indices		[in] array of vertex indices (or null)
 *	\param		verts		[in] array of vertices
 *	\return		true if success
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
