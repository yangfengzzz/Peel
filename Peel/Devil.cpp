...
..\..\..\PEEL_Externals\DevIL_1 .8.0\include..\..\..\PEEL_Externals\DevIL_1 .8.0\lib\x86\Release
...
#ifdef COMPILE_DEVIL
        // DevIL wrapper copied from '\APPs\#Plugins\SystemPlugs\IceDevil.cpp' (ICE). Probably old and obsolete but it
        // still works.
...
static ILboolean(ILAPIENTRY* gFunc_ilTexImage)(
        ILuint Width, ILuint Height, ILuint Depth, ILubyte Bpp, ILenum Format, ILenum Type, ILvoid* Data) = null;
