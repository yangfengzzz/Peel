...
BitmapWindow::BitmapWindow(const WindowDesc& desc) : IceWindow(desc) { mMainW = null; }

BitmapWindow::~BitmapWindow() {}

void BitmapWindow::redraw() { CopyPictureToWindow(GetHandle(), mMainW->mPic, false); }

static void CreateBitmapWindow(Widgets& owner,
                               BitmapWindow*& bitmap,
                               IceGroupBox*& group,
                               RaytracingWindow* parent,
                               sdword x,
                               sdword y,
                               udword width,
                               udword height,
...
RaytracingWindow* CreateRaytracingWindow(
    ...
    CreateBitmapWindow(owner, TTWindow->mRGBWindow, TTWindow->mRGBGroup, TTWindow, BORDER_SIZE, BORDER_SIZE,
                       TextureWidth, TextureHeight, "================ Raytraced view =================");
