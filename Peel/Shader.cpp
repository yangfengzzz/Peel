...
PEEL::Shader::~Shader() { DeleteShaders(); }
...
bool PEEL::Shader::LoadShaderCode(const char* vertexShaderCode,
...
void PEEL::Shader::DeleteShaders() { GLShader::ReleaseProgram(mData); }
