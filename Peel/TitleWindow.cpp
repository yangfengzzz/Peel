...
TitleBitmapWindow::TitleBitmapWindow(const WindowDesc& desc) : IceWindow(desc) { mMainW = null; }

TitleBitmapWindow::~TitleBitmapWindow() {}

void TitleBitmapWindow::redraw() { CopyPictureToWindow(GetHandle(), mMainW->mPic, false); }

static void CreateBitmapWindow(Widgets& owner,
                               TitleBitmapWindow*& bitmap,
                               /*IceGroupBox*& group,*/ TitleWindow* parent,
                               sdword x,
                               sdword y,
                               udword width,
                               udword height,
...
TitleWindow* CreateTitleWindow(Widgets& owner, IceWidget* parent, sdword x, sdword y) {
    ...
    CreateBitmapWindow(owner, TTWindow->mRGBWindow, /*TTWindow->mRGBGroup,*/ TTWindow, BORDER_SIZE_X, BORDER_SIZE_Y,
