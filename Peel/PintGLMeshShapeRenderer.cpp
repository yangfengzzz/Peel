...
PintGLMeshShapeRenderer::PintGLMeshShapeRenderer(const PintSurfaceInterface& surface,
                                                 udword flags,
                                                 const Point* normals) {
    ...
    if (normals) {
        ...
        mMesh = OpenGLMesh::Create(surface.mNbVerts, surface.mVerts, normals, surface.mNbFaces, surface.mDFaces,
                                   surface.mWFaces, type);
        ...
        mMesh = OpenGLMesh::Create(surface.mNbVerts, surface.mVerts, null, surface.mNbFaces, surface.mDFaces,
                                   surface.mWFaces, type);
    }
}

PintGLMeshShapeRenderer::~PintGLMeshShapeRenderer() { OpenGLMesh::Release(mMesh); }
...
PintGLMeshShapeRendererEx::PintGLMeshShapeRendererEx(const MultiSurface& multi_surface, udword flags) {
    if (flags & DL_MESH_USE_ACTIVE_EDGES) mActiveEdges.CreateDL(multi_surface.GetSurfaceInterface());
...
PintGLMeshShapeRendererEx::~PintGLMeshShapeRendererEx() { OpenGLMesh::Release(mMesh); }
