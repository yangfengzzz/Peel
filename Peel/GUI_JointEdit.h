...
/*	class EditJointTypeCallback
        ...
        class JointTypeComboBox : public IceComboBox
        {
                ...
                public:
                                                JointTypeComboBox(const ComboBoxDesc& desc, EditJointTypeCallback& cb) :
   IceComboBox(desc), mCallback(cb)	{}
        ...
        JointTypeComboBox* CreateJointComboBox(IceWidget* parent, sdword x, sdword y, void* user_data,
   EditJointTypeCallback& callback);
*/
#endif
