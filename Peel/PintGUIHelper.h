...
public:
    ...
    inline_ void Register(IceGUIElement* widget) { mWidgets.AddPtr(widget); }

    inline_ void Release() { DeleteOwnedObjects<IceGUIElement>(mWidgets); }
...
public:
    ...
    virtual IceLabel* CreateLabel(
            IceWidget* parent, sdword x, sdword y, sdword width, sdword height, const char* label, Widgets* owner) = 0;
...
ComboBoxType* CreateComboBox(IceWidget* parent,
                             udword id,
                             sdword x,
                             sdword y,
                             sdword width,
...
struct WidgetPtr {
    ...
    inline_ WidgetPtr& operator=(WidgetT* widget) {
        mWidget = widget;
        return *this;
    }
