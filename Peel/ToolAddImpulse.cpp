...
void ToolAddImpulse::CreateUI(PintGUIHelper& helper, IceWidget* parent, Widgets& owner) {
    ...
    helper.CreateEditBox(parent, 0, x + OffsetX, 0, EditBoxWidth, 20, helper.Convert(gImpulseMagnitude), &owner,
                         EDITBOX_FLOAT_POSITIVE, Local::gEBCallback, gTooltip_ImpulseMagnitude);
}
