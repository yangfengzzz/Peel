...
void GLTexture::ReleaseTexture(GLuint texId) { glDeleteTextures(1, &texId); }
...
//	glHint(GL_GENERATE_MIPMAP_HINT_SGIS, GL_FASTEST);
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GLFormat, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, pixels ? pixels :
pixels0); DELETEARRAY(pixels0); return TextureID;
}
*/