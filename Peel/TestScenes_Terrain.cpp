    ...
    public:
        ...
        virtual bool Setup(Pint& pint, const PintCaps& caps) {
            if (!caps.mSupportRigidBodySimulation || !caps.mSupportMeshes || !caps.mSupportDeformableMeshes)
                return false;
            if (gUseContactModif && !caps.mSupportContactModifications) return false;
        ...
        virtual ContactModif ModifyContact(Pint& pint,
            ...
            if (!mModifyContacts || !TerrainActor) return CONTACT_AS_IS;
        ...
        void DeformTerrainWithContactModifs(Pint& pint, float dt) {
            ...
            if (!TerrainActor || !TerrainShape) return;
        ...
        void UpdateTerrainVertices(Pint_Shape* ShapeAPI,
                                   Point* verts,
                                   PintActorHandle TerrainActor,
                                   PintShapeHandle TerrainShape) {
            if (verts) {
