...
class TestBase : public SurfaceManager, /*public ObjectsManager,*/ public PhysicsTest {
    ...
    public:
        ...
        void Generate(
                udword nb_x, udword nb_z, const Point& scale, float sine_freq = 0.0f, float sine_amplitude = 0.0f);
...
public:
    ...
    void RegisterConvexSweep(const udword convex_object_index,
    ...
    void RegisterTestData(TestData* data) { mTestData.AddPtr(data); }
...
public:
    inline_ void SetDefEnv(PINT_WORLD_CREATE& desc, bool b) { desc.mCreateDefaultEnvironment = b; }
