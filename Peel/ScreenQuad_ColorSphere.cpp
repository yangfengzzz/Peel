...
void ScreenQuadColorSphere::CreateUI(PintGUIHelper& helper, Widgets* widgets, IceWindow* parent) {
    ...
    IceEditBox* EB = helper.CreateEditBox(parent, 0, x + 10 + OffsetX, y2, EditBoxWidth, 20, helper.Convert(mSpread),
                                          widgets, EDITBOX_FLOAT_POSITIVE, gEBCallback, null /*gTooltip_ColorSpread*/);
    EB->SetUserData(this);
}
