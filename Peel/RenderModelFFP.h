...
#ifndef RENDER_MODEL_FFP_H
#define RENDER_MODEL_FFP_H

#include "RenderModel.h"

// Fixed Function Pipeline
class RenderModel_FFP : public RenderModel {
public:
    RenderModel_FFP();
    virtual ~RenderModel_FFP();

    // RenderModel
    virtual const char* GetUIName() const override { return "Fixed Function Pipeline"; }
    ...
    virtual PintShapeRenderer* _CreateMeshRenderer(const PintSurfaceInterface& surface,
                                                   const Point* normals,
                                                   bool active_edges,
                                                   bool direct_data) override;
    virtual PintShapeRenderer* _CreateMeshRenderer(const MultiSurface& multi_surface,
                                                   bool active_edges,
                                                   bool direct_data) override;
    virtual PintShapeRenderer* _CreateColorShapeRenderer(PintShapeRenderer* renderer,
                                                         const RGBAColor& color,
                                                         const ManagedTexture* texture) override;
    //~RenderModel
};
